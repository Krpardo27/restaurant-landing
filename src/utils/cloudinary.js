...
export const cldThumb = (id, w = 200) =>
  `https://res.cloudinary.com/${import.meta.env.VITE_CLOUDINARY_CLOUD}/image/upload/f_auto,q_auto,c_fill,g_auto,w_${w},h_${w}/${id}`;

export const cldDetail = (id, w = 1200) =>
  `https://res.cloudinary.com/${import.meta.env.VITE_CLOUDINARY_CLOUD}/image/upload/f_auto,q_auto,c_fill,g_auto,w_${w},h_800/${id}`;
